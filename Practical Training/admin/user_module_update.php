...
if(isset($_POST['submit'])){
	...
	$query="update CM_student set student_name='{$_POST['student_name']}',student_number='{$_POST['student_number']}',student_school='{$_POST['student_school']}',student_college='{$_POST['student_college']}',student_sex='{$_POST['student_sex']}'where rID='{$_GET['id']}'";
	execute($link,$query);
	...
	if(mysqli_affected_rows($link)>=0){
		...
		skip('user_module.php','error','该学号已存在！');
	}
...
<div id="main" style = "margin-left:250px">
	...
	<form method="post">
		<table class="au">
			...
			<tr>
				<td>学号</td>
				<td><input name="student_number" value="<?php echo $data['student_number']?>" type="text" /></td>
				<td>学号不可与其他学生重复</td>
			</tr>
			<tr>
				<td>所属学校</td>
