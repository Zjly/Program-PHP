...
$query="select course_id from CM_course where cID ='{$_GET['cID']}'";
$result=execute($link,$query);
$course_id=mysqli_fetch_array($result);
$course_id=$course_id['course_id'];

$A=$_GET['cID'];
$adress="course_all.php?cID={$A}";
@$query="select * from CM_class_introduce where cID ='{$A}'";
    $result=execute($link,$query);
$class_introduce=mysqli_fetch_array($result);
...
<div class="blog-content" style = "margin-left:20px;margin-right:20">
    ...
    <?php include_once 'index.inc/index2.inc.php';?>
                                <p><?php echo $class_introduce['jianjie']?></p>
                                <p><strong>课程概论</strong>
                                </p>
                                <p><?php echo $class_introduce['gailun']?></p>
				...
				<div class="single-footer">
					...
					<div class="footer-left">
						<div class="footer-logo">
							<p>代码全写队 <br> 产品经理： 彭英杰 项目经理：张雷 技术经理：马赞 成员：汪志豪 余冠达</p>
						</div>
